...
SELECT SUBSTR('HelloWorld', 1, 5) FROM dual; -- 1~5번째
...
-- LPAD() : 길이가 n이 되도록 왼쪽부터 문자식을 채운 표현식을 반환합니다.
SELECT LPAD('salary', 10, '*') FROM dual;

-- RPAD() : 길이가 n이 되도록 오른쪽부터 문자식을 채운 표현식을 반환합니다.
...
NVL2() 함수
    ...
    첫번째 표현식이 null이면 세번재 표현식을 반환합니다.
*/
