...
-- 특정 열 선택
SELECT departments_id, location_id
FROM departments;
...
*/
SELECT last_name, 12*salary*commission_pct, commission_pct, salary
FROM employees;
...
대체 인용(q) 연산자
    ...
    가독성 및 사용성이 증가합니다.
*/
SELECT department_name || q'[ Departmet's Manager ID:  ]' || manager_id
